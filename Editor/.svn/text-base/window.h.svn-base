...
class Window
{
    ...
    public:
        ...
        void setRenderingSection(double leftPercentage, double rightPercentage, double lowerPercentage, double upperPercentage);

		void renderAllWindow();

		std::string getSaveFile(std::string startingDirectory);

		std::string getLoadFile(std::string startingDirectory);
};
